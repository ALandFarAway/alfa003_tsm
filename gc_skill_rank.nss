...
/*
	...
	-	11	INTIMIDATE							XX42  PERFORM STRINGED INSTRUMENTS
	-	12	LISTEN								42  PERFORM SING
	-	13	BALANCE								XX43  PERFORM PERCUSSION
	-	14	MOVE SILENTLY						XX44  PERFORM KEYBOARDS
	-	15	OPEN LOCK							XX45  PERFORM WIND INSTRUMENTS
	-	16	PARRY								XX46  PERFORM COMEDY
	-	17	PERFORM								48  PROFESSION
	-	18	RIDE								49  SENSE MOTIVE 
	-	19	SEARCH								50  SPEAK LANGUAGE
	-	20	DECIPHER SCRIPT						51  SWIM
	-	21	SLEIGHT OF HAND						52  USE ROPE
	-	22	SPELLCRAFT							53  KNOWLEDGE GEOGRAPHY
	-	23	SPOT								54  KNOWLEDGE NOBILITY
	-	24	SURVIVAL							55  KNOWLEDGE ENGINEERING
	-	25	DIGUISE								56  KNOWLEDGE LOCAL
	-	26	TUMBLE								
	-	27	USE MAGIC DEVICE
